...
(async () => {
    ...
    // Get only 300 messages to avoid flood wait
    console.log('Fetching last 300 messages from ' + targetGroup + '...');
    try {
        const messages = await client.getMessages(targetGroup, { limit: 300 });
        ...
        console.log('\n=== FOUND ' + models.size + ' REAL MODELS IN LAST 300 MESSAGES ===');
