...
const wf = JSON.parse(fs.readFileSync('scratch/final_v5_patched_fixed9.json', 'utf8'));
...
fs.writeFileSync('scratch/final_v5_patched_fixed10.json', JSON.stringify(wf, null, 2));
console.log("scratch/final_v5_patched_fixed10.json written!");
