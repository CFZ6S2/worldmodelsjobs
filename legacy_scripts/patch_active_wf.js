...
const rawText = fs.readFileSync('active_workflow.json', 'utf8');
const lines = rawText.split('\n');
const jsonLine = lines.find(l => l.startsWith('[{"updatedAt"'));

const wf = JSON.parse(jsonLine)[0];
...
fs.writeFileSync('active_workflow_fixed.json', JSON.stringify(wf, null, 2));
console.log("active_workflow_fixed.json generated successfully!");
