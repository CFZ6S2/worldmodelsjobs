...
const wf = JSON.parse(fs.readFileSync('scratch/final_v5_patched_fixed3.json', 'utf8'));
...
// MONACO (Eliminado 'nice', 'viena', 'vienna' por colisiones con inglés)
...
// 2. PATCH DYNAMIC ROUTING ENGINE (Remove nice, viena)
...
fs.writeFileSync('scratch/final_v5_patched_fixed4.json', JSON.stringify(wf, null, 2));
console.log("scratch/final_v5_patched_fixed4.json written!");
