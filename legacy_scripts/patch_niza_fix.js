...
const wf = JSON.parse(fs.readFileSync('scratch/final_v5_patched_fixed10.json', 'utf8'));
...
// MONACO
// Fix: Added word boundaries \\b to niza to avoid matching words like "organiza"
...
fs.writeFileSync('scratch/final_v5_patched_fixed11.json', JSON.stringify(wf, null, 2));
console.log("scratch/final_v5_patched_fixed11.json written!");
