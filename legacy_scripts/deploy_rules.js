...
execSync('node patch_rules.js', { stdio: 'inherit' });
execSync('scp scratch/final_v5_patched_fixed3.json root@178.156.186.149:/tmp/final_v5_patched_fixed3.json', { stdio: 'inherit' });
