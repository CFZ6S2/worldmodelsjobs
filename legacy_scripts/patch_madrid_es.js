...
const wf = JSON.parse(fs.readFileSync('scratch/final_v5_patched_fixed4.json', 'utf8'));
...
fs.writeFileSync('scratch/final_v5_patched_fixed5.json', JSON.stringify(wf, null, 2));
console.log("scratch/final_v5_patched_fixed5.json written!");
